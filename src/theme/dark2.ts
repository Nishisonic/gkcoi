...
async function generateDarkShipInfoCanvasAsync(
  ...
  // overlay
  ctx.lineWidth = 3;
  ctx.strokeStyle = "rgb(32,141,195)";
  // ctx.fillRect(0, 0, 650, 176);
  ctx.beginPath();
  ctx.moveTo(1, 1);    // 左上
  ctx.lineTo(600, 1);   // 右上
  ctx.lineTo(649, 175);  // 右下
  ctx.lineTo(50, 175);  // 左下
  ctx.closePath();
  // ctx.fill();
  ctx.stroke();
  ctx.strokeStyle = "rgb(32,141,195)";
  ctx.fillStyle = "rgb(32,141,195,0.6)";
  ctx.beginPath();
  ctx.moveTo(1, 20);    // 左上
  ctx.lineTo(45, 175);   // 右上
  ctx.lineTo(1, 175);  // 右下
  ctx.lineTo(1, 20);  // 左下
  ctx.closePath();
  ctx.fill();
  ...
  ctx.strokeStyle = "rgb(32,141,195)";
  ctx.fillStyle = "rgba(203,230,243,0.6)";
  ctx.lineWidth = 2;
  ctx.beginPath();
  ctx.moveTo(343, 6);    // 左上
  ctx.lineTo(594, 6);   // 右上
  ctx.lineTo(600, 29);  // 右下
  ctx.lineTo(351, 29);  // 左下
  ctx.closePath();
  ctx.stroke();
  ctx.fill();
  ctx.lineWidth = 1;
  ctx.beginPath();
  ctx.moveTo(349, 32.5);    // 左上
  ctx.lineTo(600, 32.5);   // 右上
  ctx.closePath();
  ctx.stroke();
  ctx.lineWidth = 2;
  ...
  for (let i = 0; i < 6; i++) {
    ctx.beginPath();
    ctx.moveTo(350+i*6.5, 36+i*23);    // 左上
    ctx.lineTo(601+i*6.5, 36+i*23);   // 右上
    ctx.lineTo(607+i*6.5, 55+i*23);  // 右下
    ctx.lineTo(358+i*6.5, 55+i*23);  // 左下
    ctx.closePath();
    ctx.stroke();
    ctx.fill();
...
async function generateDarkShipInfoCanvasAsync2(
  shipIdx: number,
  ship: Ship,
  lang: Lang = "jp",
  options?: DeckBuilderOptions,
  ...
  ctx.strokeStyle = "rgb(32,141,195)";
  ctx.beginPath();
  ctx.moveTo(649, 20);   // 右上
  ctx.lineTo(649, 175);  // 右下
  ctx.lineTo(605, 175);  // 左下
  ctx.lineTo(649, 20);    // 左上
  ctx.closePath();
  ctx.fill();
  ctx.stroke();
  ...
  for (let i = 0; i < 6; i++) {
    ctx.beginPath();
    ctx.moveTo(358+(5-i)*6.5, 36+i*23-28);    // 左上
    ctx.lineTo(607+(5-i)*6.5, 36+i*23-28);   // 右上
    ctx.lineTo(601+(5-i)*6.5, 55+i*23-28);  // 右下
    ctx.lineTo(350+(5-i)*6.5, 55+i*23-28);  // 左下
    ctx.closePath();
    ctx.stroke();
    ctx.fill();
    // if (ship.items[i].id > 0) {
...
async function generateDarkShipCanvasAsync(
  ...
  const shipInfoCanvas = shipIdx === 0 ? await generateDarkShipInfoCanvasAsync(
    shipIdx,
    ship,
    lang,
    options,
  ) : await generateDarkShipInfoCanvasAsync2(
    shipIdx,
    ship,
    lang,
    options,
 ...
 * @return 画像
 */
export async function generateDark2FleetCanvasAsync(
  fleetIdx: number,
  ships: Ship[],
  los: LoS,
  airPower: AirPower,
